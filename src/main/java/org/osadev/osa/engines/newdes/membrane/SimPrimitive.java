/*
 * Generated by org.objectweb.fractal.koch.mc.MembraneCompiler on: Mon Nov 23 17:42:07 CET 2015
 */
...
/**
 * Implementation of the SimPrimitive membrane factory component.
 *
 * @author Lionel Seinturier <Lionel.Seinturier@lifl.fr>
 * @since 2.5
 */
public class SimPrimitive implements org.objectweb.fractal.api.factory.Factory, org.objectweb.fractal.api.control.BindingController {
...
InterfaceType IT16 = typeFactory.createFcItfType("//simulation-controller", "org.osadev.osa.simapis.simulation.ProcessSimulationControllerAPI", false, false, false);
...
InterfaceType IT18 = typeFactory.createFcItfType("//modeling-process-controller", "org.osadev.osa.simapis.modeling.ProcessModelingAPI", false, false, false);
ComponentType CT7 = typeFactory.createFcType(new InterfaceType [] { IT15, IT16, IT17, IT18 });
Component C7 = genericFactory.newFcInstance(CT7, "mPrimitive", "org.osadev.osa.engines.newdes.impl.llong.ProcessSimulationControllerImpl");
try { Fractal.getNameController(C7).setFcName("SimC"); } catch (NoSuchInterfaceException ignored) { }
InterfaceType IT19 = typeFactory.createFcItfType("//lifecycle-controller", "org.objectweb.fractal.julia.control.lifecycle.LifeCycleCoordinator", false, false, false);
...
InterfaceType IT21 = typeFactory.createFcItfType("//component", "org.objectweb.fractal.api.Component", false, false, false);
InterfaceType IT22 = typeFactory.createFcItfType("//name-controller", "org.objectweb.fractal.api.control.NameController", false, false, false);
...
InterfaceType IT24 = typeFactory.createFcItfType("///interceptor-controller", "org.objectweb.fractal.koch.control.interceptor.InterceptorController", false, false, false);
InterfaceType IT25 = typeFactory.createFcItfType("///membrane-controller", "org.objectweb.fractal.koch.control.membrane.MembraneController", false, false, false);
InterfaceType IT26 = typeFactory.createFcItfType("//simulation-controller", "org.osadev.osa.simapis.simulation.ProcessSimulationControllerAPI", false, false, false);
InterfaceType IT27 = typeFactory.createFcItfType("//modeling-event-controller", "org.osadev.osa.simapis.modeling.EventModelingAPI", false, false, false);
InterfaceType IT28 = typeFactory.createFcItfType("//modeling-process-controller", "org.osadev.osa.simapis.modeling.ProcessModelingAPI", false, false, false);
ComponentType CT8 = typeFactory.createFcType(new InterfaceType [] { IT19, IT20, IT21, IT22, IT23, IT24, IT25, IT26, IT27, IT28 });
Component C8 = genericFactory.newFcInstance(CT8, "mComposite", null);
try { Fractal.getNameController(C8).setFcName("org.osadev.osa.engines.newdes.membrane.SimPrimitive"); } catch (NoSuchInterfaceException ignored) { }
...
Fractal.getBindingController(C8).bindFc("//modeling-process-controller", C7.getFcInterface("//modeling-process-controller"));
...
Fractal.getLifeCycleController(C8).startFc();
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType() {
    try {
      // --------------------------------------------------
InterfaceType IT29 = typeFactory.createFcItfType("//lifecycle-controller", "org.objectweb.fractal.julia.control.lifecycle.LifeCycleCoordinator", false, false, false);
InterfaceType IT30 = typeFactory.createFcItfType("//binding-controller", "org.objectweb.fractal.api.control.BindingController", false, false, false);
InterfaceType IT31 = typeFactory.createFcItfType("//component", "org.objectweb.fractal.api.Component", false, false, false);
InterfaceType IT32 = typeFactory.createFcItfType("//name-controller", "org.objectweb.fractal.api.control.NameController", false, false, false);
InterfaceType IT33 = typeFactory.createFcItfType("//super-controller", "org.objectweb.fractal.julia.control.content.SuperControllerNotifier", false, false, false);
InterfaceType IT34 = typeFactory.createFcItfType("///interceptor-controller", "org.objectweb.fractal.koch.control.interceptor.InterceptorController", false, false, false);
InterfaceType IT35 = typeFactory.createFcItfType("///membrane-controller", "org.objectweb.fractal.koch.control.membrane.MembraneController", false, false, false);
InterfaceType IT36 = typeFactory.createFcItfType("//simulation-controller", "org.osadev.osa.simapis.simulation.ProcessSimulationControllerAPI", false, false, false);
InterfaceType IT37 = typeFactory.createFcItfType("//modeling-event-controller", "org.osadev.osa.simapis.modeling.EventModelingAPI", false, false, false);
InterfaceType IT38 = typeFactory.createFcItfType("//modeling-process-controller", "org.osadev.osa.simapis.modeling.ProcessModelingAPI", false, false, false);
ComponentType CT9 = typeFactory.createFcType(new InterfaceType [] { IT29, IT30, IT31, IT32, IT33, IT34, IT35, IT36, IT37, IT38 });
      // --------------------------------------------------
      return CT9;
    }
    catch( Exception e ) {
